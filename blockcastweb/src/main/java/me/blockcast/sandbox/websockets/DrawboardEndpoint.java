...
import me.blockcast.sandbox.websockets.DrawMessage.ParseException;
            ...
            public void run() {
                try {
                    ...
                    try {
                        ...
                        // reached.
                        client.sendMessage(new me.blockcast.sandbox.websockets.wsmessages.StringWebsocketMessage(
